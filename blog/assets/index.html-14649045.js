import{_ as n,o as s,c as a,a as e}from"./app-a6a5d4a7.js";const t={},i=e(`<h2 id="一、安装" tabindex="-1"><a class="header-anchor" href="#一、安装" aria-hidden="true">#</a> 一、安装</h2><p><a href="https://juejin.cn/post/6844904147557285895#heading-1" target="_blank" rel="noopener noreferrer">使用Docker搭建ELK环境</a></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 下载</span>
