import{_ as n,o as s,c as a,a as t}from"./app-c399b13a.js";const e={},p=t(`<h3 id="_1-什么是json-schema" tabindex="-1"><a class="header-anchor" href="#_1-什么是json-schema" aria-hidden="true">#</a> 1. 什么是JSON Schema</h3><p>JSON Schema本身就是一种数据结构，可以清晰的描述JSON数据的结构，是一种描述JSON数据的JSON数据</p><h3 id="_2-使用json-schema的好处" tabindex="-1"><a class="header-anchor" href="#_2-使用json-schema的好处" aria-hidden="true">#</a> 2. 使用JSON Schema的好处</h3><ul><li>JSON Schema从Java的基本数据类型中对JSON结构进行校验，所以对JSON结构的校验可以理解为对每种不同数据类型的相应校验</li><li>接口测试中可以快速的定位到自己数据格式的正确性</li><li>JSON Schema 非常适用于基于JSON的HTTP的API</li></ul><h3 id="_3-常用关键字" tabindex="-1"><a class="header-anchor" href="#_3-常用关键字" aria-hidden="true">#</a> 3. 常用关键字</h3><p>JSON Schema实例</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
